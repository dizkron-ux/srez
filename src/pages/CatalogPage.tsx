  ...
  return (
    <div className="srez-app">
      ...
      <main className="srez-shell">
        <section className="srez-catalog-head"><button className="srez-back" onClick={() => go('Home')}>← Назад</button><span className="srez-eyebrow">Вы ищете</span><h1>Mullet</h1><p className="srez-catalog-lead">Мастера с подтверждениями по выбранной форме и признакам.</p><SearchComposer go={go} /><div className="srez-active-filters"><button className="cosmos-chip">Mullet</button><button className="cosmos-chip">Волнистые</button><button className="cosmos-chip">Средняя длина</button></div></section>
